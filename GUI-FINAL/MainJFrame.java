...
public class MainJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(205, 25, 255));
        jPanel1.setForeground(new java.awt.Color(2, 255, 255));

        jPanel2.setBackground(new java.awt.Color(255, 102, 102));

        jLabel1.setBackground(new java.awt.Color(205, 25, 255));
        jLabel1.setFont(new java.awt.Font("Segoe UI Black", Font.PLAIN, 24)); // NOI18N
        jLabel1.setText("SCHOOL MANAGEMENT SYSTEM");

        jButton6.setFont(new java.awt.Font("Segoe UI", Font.BOLD, 18)); // NOI18N
        jButton6.setText("X");
        ...
        jButton5.setFont(new java.awt.Font("Segoe UI", Font.BOLD, 14)); // NOI18N
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(Objects.requireNonNull(getClass().getResource("/Library.jpg")))); // NOI18N

        jButton4.setFont(new java.awt.Font("Segoe UI", Font.BOLD, 14)); // NOI18N
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {
        //Create an instance of the Analytics JPanel
        Analytics analyticsPanel=new Analytics();

        JFrame analyticsFrame=new JFrame ("Student Analytics");
        analyticsFrame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);//Close only this Frame
        analyticsFrame.setContentPane(analyticsPanel);
        analyticsFrame.setSize(1100, 600);
